...
public class RunHelper {
    ...
    public Class<?> getDriverClass() {
        ...
        switch (deviceHost) {
            case "browserstack":
                return BrowserStackDriver.class; //можно создать этот класс и реализовать доп логику для BrowserStack
            case "selenoid":
               return SelenoidDriver.class; //можно создать этот класс и реализовать доп логику для Selenoid и многопоточности
            case "emulator":

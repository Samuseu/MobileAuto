...
import static helper.TouchActions.clickOnCenter;
...
public class MainPage extends SearchPage {
    ...
    private SelenideElement adPopUp = $(MobileBy.id("design_bottom_sheet"));
    ...
    public MainPage checkCategoriesHasTexts(List<String> texts) {
        androidScrollToAnElementByText(texts.get(1));
